...
A lighter variant of extract_lyrics.py (does not write intermediate debug images).

Usage:
    python extract_version_lyrics.py <video_path> [--out-dir DIR] [--max-frames N] [--every N]
...
def main():
    ...
    parser.add_argument("--out-dir", default="video/frames2", help="Directory for dumped frames.")
